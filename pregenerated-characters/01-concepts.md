# Eight members of the Last Wagon Company

These are starting PCs for **Fantasy Crux 2.0 Beta**, built for the Crownless Realms. Choose from eight characters; eight players are not required. The first five develop the existing [Last Wagon Company briefs](../adventures/the-lamp-that-went-dark/03-party-and-player-brief.md). The last three are new company members who also helped at the flooded caravan. All grew up in the Whitewater March and speak River Crown as their own language. Ancestry does not confer a foreign language or culture.

The shared promise is simple: **nobody gets left behind**. Everyone signed the same equal-share charter. Their backgrounds explain their starting abilities; the company's few early errands confer no extra IP, money, or equipment. None is a secret traitor or needs another PC to fail.

## 1. Mara Holt — the steady hand
...
## 7. Seris Vale — the careful trail
...
- **Four PCs with broad coverage:** Mara, Pebb, Dori, and Tamsin.
