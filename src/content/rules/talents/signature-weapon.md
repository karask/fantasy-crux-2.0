---
type: talent
id: talent.signature-weapon
chapter: talents
title: Signature Weapon
slug: signature-weapon
order: 57
summary: Raise Favoured Weapon's damage bonus from 1 to 2 for the same chosen weapon.
aliases:
  - advanced weapon specialisation
  - advanced weapon specialization
  - greater weapon specialisation
  - greater weapon specialization
  - weapon virtuoso
cost: 4
prerequisites: Favoured Weapon for the chosen weapon and Close Combat 76% or Ranged Combat 76%, as used by that weapon
activation: passive
tags:
  - close
  - offence
