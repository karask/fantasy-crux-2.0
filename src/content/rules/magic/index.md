...
For each **outcome**, rate **Intensity** (power). Rate shared **Range** (distance), **Duration** (time), and **Reach** (number, area, or size) once. Their sum plus **adjustments** is **Magnitude**, governing cost and risk. Expertise sets **Safe Magnitude**; total ongoing Magnitude cannot exceed permanent, unmodified INT.
