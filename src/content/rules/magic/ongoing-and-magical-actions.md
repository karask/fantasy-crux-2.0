...
Spend a Combat Action and 1 PP; test Shaping for active magic within 15 metres. Success reveals location and Form; Critical adds Technique, Magnitude, and concentrated, triggered, or anchored state. Failure reveals nothing. A fumble gives a false impression and conspicuous Tell, not Backlash. Veiled magic opposes with its original result.

### Dispel {#magic-dispel}

Spend a Combat Action. Dispel Magnitude equals full target Magnitude plus Range; Reach is 0 for one Shaping regardless of area. Test and pay normally. On Success or Critical, oppose that result with the original Shaper's current unmodified Shaping; if unknown, use `10 × original Magnitude`, maximum 100%. The dispeller must succeed and win.
