...
Fantasy Crux 2.0 Beta is a fantasy RPG rules set. Its canonical source is portable Markdown, rendered as the responsive **Cold Iron** static website. The current playtest rules cover character creation, skills, equipment, combat, adventuring, 54 optional Talents, freeform Shaping magic, Gamemaster tools, and a 57-profile bestiary.
